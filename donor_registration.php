            ...
            <div id='cssmenu'>
                <ul>      
                    ...
                    <li class='active has-sub'><a href='#'><span>Registration</span></a>
                        <ul>
                            <li><a href='#'><span>Donor Registration</span></a></li>
                    ...
                    <li class='active has-sub'><a href='#'><span>Donation</span></a>
                        <ul>
                            <li><a href='existing_patient_before.php'><span>Existing Donor</span></a></li>
                            <li><a href='existing_patient.php'><span>Existing Patient</span></a></li>
                        </ul>
                    </li>
        			...
        			<div id="signup-inner">
        				<div class="clearfix" id="header">        
 						...
 						<form id="send" action="donor_registration.php" onSubmit="return(validate());" name="registration" method="post" >
                            ...
                            <p>
                            <label for="bgroup">Blood Group: <select style="background-color:#FF;color:#666;width: 210px;padding: 4px;font-size: 15px;border: 1px solid black;border-radius: 0;height: 30px;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;margin-left:15px" name="donor_blood_group">
                            ...
                            <p>
                            <label for="city">City: <select style="background-color:#FF;color:#666;width: 210px;padding: 4px;font-size: 15px;border: 1px solid black;;border-radius: 0;height: 30px;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;margin-left:18px" name="donor_city">
