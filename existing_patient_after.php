	...
	<div id="temp">  
    	<div id="bankpage">
            ...
            <div id="maindiv">
            	...
            	<form id="send" action="existing_patient_after.php" method="post" >
				<h2><span style="color:#CC0000">Step 3: </span>Donation Completion</h2>

            	 <p>
                            <label for="id"><h3>Govt. Identification Number:</h3></label>
                            <input id="id" type="text" name="id" value="<?php echo $_SESSION['patient_govt_id'];?>"  style="background-color:#FF;color:#666;width: 210px;padding: 4px;font-size: 15px;border: 1px solid black;border-radius: 0;height: 15px;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;margin-left:0px" disabled />
                            </p>
                            ...
                            <label for="bags"><h3>No. of bags:</h3></label>
                             <select style="background-color:#FF;color:#666;width: 220px;padding: 4px;font-size: 15px;border: 1px solid black;border-radius: 0;height: 30px;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;margin-left:0px" name="bags" id="bags">
							...
							<script type="text/javascript">
								document.getElementById("bags").onblur = function() {
								var xmlhttp;
								var user=document.getElementById("bags");
								if (user.value != "")
								{
								...
								xmlhttp.open("GET","existing_patient_after_validation.php?user="+encodeURIComponent(user.value),true);
								xmlhttp.send();
								}
								};
                            </script>
...
<?php
if(isset($_POST['submit']) && $_SESSION['step3']==1 )
{
		...
		else
		{
			...
			echo 'location.href="existing_patient_after.php"';
			echo '</script>';
		}
			
}
if(isset($_POST['submit']) && $_SESSION['step3']==0)
		{
			echo '<script>';
			echo 'alert("Donation cannot be processed!");';
			echo 'location.href="existing_patient_after.php"';
