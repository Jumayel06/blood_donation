	...
	<div id="temp">  
    	<div id="bankpage">
            ...
            <div id="maindiv">
            	...
            	<form id="send" action="existing_patient_before.php" method="post" >
				<h2><span style="color:#CC0000">Step 1: </span>Inquiry</h2>
                 ...
                 <h5 class="error" id="error3" style="color:red;"></h5>
							<script type="text/javascript">
								...
								xmlhttp.open("GET","existing_patient_before_validation.php?user="+encodeURIComponent(user.value),true);
								xmlhttp.send();
								}
								};
                            </script>
							<input type="radio" name="Confirm" id="Confirm" value="Confirm"><span style="font-size:16px;font-weight:bold;">Confirm your identity</span>


                  <p>
                            <button id="next" class="next" type="submit" name="next" style="margin-left:60px;">Next</button>
                            </p>
                 </form>
                 </div>
            </div>
...
if(isset($_POST['next']) && isset($_POST['Confirm']))
{
		...
		if($_SESSION['step1']==1)
		{
	      		echo'<script> window.location="existing_patient.php"; </script> ';

		}
		else
		{
			echo '<script>';
			echo 'alert("This process cannot be completed!");';
			echo 'location.href="existing_patient_before.php"';
			echo '</script>';
		}
