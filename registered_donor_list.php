    	...
    	<div id="bankpage">
                ...
                <ul>      
                    ...
                    <li class='active has-sub'><a href='#'><span>Inquiry</span></a>
                        <ul>
                            ...
                            <li><a href='#'><span>List of Registered Donors</span></a></li>
			...
			<?php			
						...
						while($row = mysql_fetch_array($result))
						{
	        				...
	        				$result = mysql_query("SELECT * FROM donor WHERE bank_id='$bank_id'");
	        ...
	        ?>
						...
						<table border="1" width="720px" style="margin-left:5px; class="bordered"  ">
            				<thead >
 							<tr >
    							<td style="font-family:Tahoma, Geneva, sans-serif; text-align:center; font-size:30px" width="100" align="center" colspan="7" >Registered Donors</td>
  							</tr>
  							<tr >
		                        ...
		                        <td style="text-align:center;font-weight:bold; color:black;font-size:18px; ">Division</td>
			...
			?>
						 <tr>
    								...
    								<td><?php echo $donor_govt_id; ?></td>
    								<td><?php echo $donor_blood_group; ?></td>
                                    <td><?php echo $donor_contact_no; ?></td>
                                    <td><?php echo $donor_address; ?></td>
                                    <td><?php echo $donor_city; ?></td>
